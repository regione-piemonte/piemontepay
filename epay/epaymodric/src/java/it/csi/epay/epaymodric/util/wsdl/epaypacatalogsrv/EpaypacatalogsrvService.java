...
public class EpaypacatalogsrvService extends Service {
    ...
    static {
        ...
        try {
			...
			Logger log = LogManager.getLogger(EpaypacatalogsrvService.class.getName());
                log.info ("Can not initialize the default wsdl from http://dev-srv-epay.bilancio.csi.it/epaypacatalogsrvApplEpaypacatalogsrvWs/EpaypacatalogsrvService?wsdl");
        }
        WSDL_LOCATION = url;
    }
