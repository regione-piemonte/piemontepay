...
@XmlType ( name = "dtoTipoFileReport" )
public class DTOTipoFileReport implements Serializable {
	...
	private DTOTipoFileReport(Builder builder) {
		this.id = builder.id;
...
//	 */
	...
	public static final class Builder {
		...
		public DTOTipoFileReport build() {
			return new DTOTipoFileReport(this);
		}
	}
