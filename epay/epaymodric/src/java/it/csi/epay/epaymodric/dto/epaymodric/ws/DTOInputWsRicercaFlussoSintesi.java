...
@XmlType ( name = "dtoInputWsRicercaFlussoSintesi" )
public class DTOInputWsRicercaFlussoSintesi extends DTOInputBase {
    ...
    public String toString () {
        ...
        stringBuffer.append ( "\n " );
        stringBuffer.append ( "idFlussoOrigine: [" + idFlussoOrigine + "]" );
