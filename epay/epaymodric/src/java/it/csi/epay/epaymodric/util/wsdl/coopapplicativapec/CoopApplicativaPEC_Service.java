...
public class CoopApplicativaPEC_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8081/epaypaweb-business/CoopApplicativaPEC/CoopApplicativaPEC?wsdl");
        } catch (MalformedURLException e) {
			Logger log = LogManager.getLogger(CoopApplicativaPEC_Service.class.getName());
                log.info("Can not initialize the default wsdl from http://localhost:8081/epaypaweb-business/CoopApplicativaPEC/CoopApplicativaPEC?wsdl");
        }
        WSDL_LOCATION = url;
    }
