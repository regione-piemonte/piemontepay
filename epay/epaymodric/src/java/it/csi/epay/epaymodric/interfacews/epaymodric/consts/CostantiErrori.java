...
package it.csi.epay.epaymodric.interfacews.epaymodric.consts;
...
public abstract class CostantiErrori {
    ...
    public static final String WS_ESITO_KO_PARAM_MISSING = "253";
    ...
    public static final String RETURN_ORIGINE_PRESENTE_WARN = "049";
}
