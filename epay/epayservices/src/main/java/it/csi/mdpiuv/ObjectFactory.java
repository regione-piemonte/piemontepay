 ...
 * generated in the it.csi.mdpiuv package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.csi.mdpiuv
     * 
     */
    ...
    public JAXBElement<MdpIuvSrvException> createMdpIuvSrvException(MdpIuvSrvException value) {
        return new JAXBElement<MdpIuvSrvException>(_MdpIuvSrvException_QNAME, MdpIuvSrvException.class, null, value);
    }
