 ...
 * generated in the it.csi.mdpmultiiuv package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.csi.mdpmultiiuv
     * 
     */
    ...
    public JAXBElement<ErrorParameterException> createErrorParameterException(ErrorParameterException value) {
        return new JAXBElement<ErrorParameterException>(_ErrorParameterException_QNAME, ErrorParameterException.class, null, value);
    }
    ...
    public JAXBElement<MdpMultiIuvSrvException> createMdpMultiIuvSrvException(MdpMultiIuvSrvException value) {
        return new JAXBElement<MdpMultiIuvSrvException>(_MdpMultiIuvSrvException_QNAME, MdpMultiIuvSrvException.class, null, value);
    }
