 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://interfacecxf.core.mdp.csi.it/}ricevutaTelematicaNodo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetListaRTperIUVResponse {
    ...
    public List<RicevutaTelematicaNodo> getReturn() {
        if (_return == null) {
            _return = new ArrayList<RicevutaTelematicaNodo>();
        }
        return this._return;
    }
