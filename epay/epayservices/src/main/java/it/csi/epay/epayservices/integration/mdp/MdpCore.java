...
@Stateless ( name = "MdpCore", mappedName = "MdpCore" )
@Startup
public class MdpCore {
    ...
    public void initialization () throws MalformedURLException, ClassNotFoundException {
        ...
        if ( ( (String) properties.get ( "mdpCore.apiManager.flag" ) ).equals ( "true" ) ) {
            //TODO aggiungerlo nel build
            URL wsdlLocation = MdpCore.class.getClassLoader ().getResource ( "wsdl/MdpCoreCxf.wsdl" );
            ...
            trm.setOauthHelper ( new OauthHelper (
                (String) properties.get ( "mdpCore.apiManager.oAuthUrl" ),
                (String) properties.get ( "mdpCore.apiManager.consumerKey" ),
                (String) properties.get ( "mdpCore.apiManager.consumerSecret" ) ) );
            trm.setWsProvider ( new CxfImpl () );

            GenericWrapperFactoryBean gwfb = new GenericWrapperFactoryBean ();
            gwfb.setEndPoint ( (String) properties.get ( "mdpCore.apiManager.endPoint" ) );
            ...
            URL urlService = new URL ( (String) properties.get ( "mdpCore.url.wsdl" ) );
    ...
    public Transazione initializzaTransazione ( final Pagamento pagamento ) throws MdpException {
        ...
        } catch ( MissingParameterException_Exception | CSIException_Exception | CreateException_Exception | DaoException_Exception
                        | NamingException_Exception
    ...
    public String urlSceltaPsp ( final Pagamento pagamento, final Transazione transazione, final URL urlBack, final URL urlNext, int numberTry )
                    throws MdpException {
        try {
    ...
    public List<AppGatewayInformativa> modalitaInformativePagamento ( final String idApplicazione, Transazione transazione, int numberTry )
                    throws MdpException {
        try {
    ...
    public String paymentURL ( final Transazione transazione, final List<TransazioneExtraAttribute> transazioneExtraAttributeList, int numberTry )
                    throws MdpException {
        try {
    ...
    public String paymentURL ( final Transazione transazione, final ElencoRPT elencoRPT,Boolean multiBeneficiario, int numberTry ) throws MdpException {
        try {
            ...
            return paymentURL ( transazione, elencoRPT, multiBeneficiario, numberTry );
        }
    }
}
