...
public class PushbuttonField extends BaseField {
	...
	public PdfAppearance getAppearance () throws IOException, DocumentException {
		...
		if ( ( text == null || text.isEmpty () ) && ( layout == LAYOUT_LABEL_ONLY || ( image == null && template == null && iconReference == null ) ) ) {
			return app;
		}
		...
		if ( haveIcon ) {
			...
			if ( tp != null )
				...
				app.addTemplateReference ( iconReference, PdfName.FRM, icx, icy, xpos - cox * icx, ypos - coy * icy );
			}
			app.restoreState ();
		}
