...
import it.csi.epay.epayservices.utilities.pdfutil.otext.src.main.java.com.otextpdf.xmp.impl.Utils;
...
public final class XMPPathParser {
	...
	private static XMPPathSegment parseStructSegment ( PathPosition pos ) throws XMPException {
		...
		return new XMPPathSegment ( pos.path.substring ( pos.stepBegin, pos.stepEnd ),
