...
public class EncryptionDecryptionUtil {
    ...
    public static String encryptString ( final String data, final String sbKey ) {
    ...
    public static byte[] encryptByte ( final String data, final String sbKey ) {
...
public static String decrypt2 ( final byte [] encryptedString, final String sbKey ) {
