...
public final class BidiOrder {
	...
	private static final char[] baseTypes = {
	...
	private byte paragraphEmbeddingLevel; // undefined
	...
	public static byte getDirection ( char c ) {
		return rtypes[c];
	}
	...
	private void runAlgorithm () {
		...
		setLevels ( textLength, paragraphEmbeddingLevel );
		...
		while ( start < textLength ) {
			...
			// Rules W1-W7.
			resolveWeakTypes ( start, limit, prevType, succType );
			...
			// Rules I1, I2.
			resolveImplicitLevels ( start, limit, level );
	...
	private void resolveWeakTypes ( int start, int limit, byte sor, byte eor ) {
	...
	private void resolveImplicitLevels ( int start, int limit, byte level ) {
	...
	private void setLevels ( int limit, byte newLevel ) {
