...
public class TIFFFaxDecoder {
	...
	public TIFFFaxDecoder ( int fillOrder, int w ) {
				...
				while ( bitOffset < w ) {
					...
					if ( code == 0 ) {
						...
						throw new RuntimeException (
										MessageLocalization.getComposedMessage ( "invalid.code.encountered.while.decoding.2d.group.3.compressed.data" ) );
					}
				}
				...
				if ( code == 0 ) { // Pass
					...
					if ( nextLesserThan8Bits ( 3 ) != 7 ) {
						throw new InvalidImageException (
										MessageLocalization.getComposedMessage ( "invalid.code.encountered.while.decoding.2d.group.4.compressed.data" ) );
					}
