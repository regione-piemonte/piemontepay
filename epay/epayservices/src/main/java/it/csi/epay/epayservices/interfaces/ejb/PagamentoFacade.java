...
public interface PagamentoFacade {
    ...
    /**
     * Richiama il servizio per verificare l'attualizzazione dell'importo da pagare
     * @param organization
     * @param iuv
     * @return
    ...
    /**
     * Aggiorna l'importo e il flag di attualizzazione
     */
    public void attualizzaImporto(Long idPagamento, BigDecimal importo, Boolean requiresCostUpdate) throws NoDataException, IllegalArgumentException;
    
    
    public StatoPosizioneDebitoriaOutput getStatoPosizioneDebitoria(StatoPosizioneDebitoriaInput statoPosizioneDebitoriaInput) ;
