...
/**
 * The persistent class for the epay_t_pagamento_componenti database table.
 * 
 */
@Entity
...
public class EpayTPagamentoComponenti implements Serializable {
	...
	@Id
	@SequenceGenerator(name="EPAY_T_PAGAMENTO_COMPONENTI_IDCOMPONENTE_GENERATOR", allocationSize=1, sequenceName="EPAY_T_PAGAMENTO_COMPONENTI_ID_COMPONENTE_SEQ")
