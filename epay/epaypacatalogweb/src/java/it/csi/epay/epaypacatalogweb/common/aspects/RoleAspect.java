...
import it.csi.epay.epaypacatalogweb.frontend.AuthenticatedParentController;
...
public class RoleAspect {
	...
	@Around(value="execution(* it.csi.epay.epaypacatalogweb.frontend..*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)", argNames = "joinPoint")
