...
/**
 *
 * @author lorenzo.fantini Classe che effettua fisicamente la pre autenticazione su Shibboleth e passa il controllo a Spring MVC Da loadUserDetails, nel caso in
 *         cui l'utente venga riconosciuto, uscira' un utente valorizzato con nome, cognome, cf e ruoli
 */
public class ShibbolethUserDetailsServiceWrapper implements AuthenticationUserDetailsService<PreAuthenticatedAuthenticationToken>, InitializingBean {
    ...
    public UserDetails loadUserDetails ( PreAuthenticatedAuthenticationToken authentication ) throws UsernameNotFoundException {
        ...
        return userDetailsService.caricaUtenteDaIdentita ( identityDetails, getIrideAPP () );
    }
