...
import it.csi.epay.epaypacatalogweb.model.cache.CachedElement;
...
public class HttpUtils {
	...
	private static Map<String, CachedElement<String>> Cache = new LinkedHashMap<String, CachedElement<String>>();
	private static Logger Logger = LoggerFactory.getLogger(LogConfig.HANDLER_UTILS);
	...
	public static String getResourceFromUrl(String url) {
		...
		if (!isEmpty(url)) {
			...
			if (page != null && page.isValid(PAGE_TIMEOUT)) {
				...
				Cache.put(url, new CachedElement<String>(resource));
			}
		}
