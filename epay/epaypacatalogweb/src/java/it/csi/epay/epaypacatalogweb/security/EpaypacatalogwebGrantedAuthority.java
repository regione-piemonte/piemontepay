...
public class EpaypacatalogwebGrantedAuthority implements GrantedAuthority {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EpaypacatalogwebGrantedAuthority other = (EpaypacatalogwebGrantedAuthority) obj;
		if (codice == null) {
	...
	public EpaypacatalogwebGrantedAuthority(String codice, String descrizione, String descEstesa, String descMoltoEstesa, int tipoAuthority) {
		super();
		this.codice = codice;
	...
	public EpaypacatalogwebGrantedAuthority(String codice, String descrizione, int tipoAuthority) {
		super();
		this.codice = codice;
		this.descrizione = descrizione;
		this.tipoAuthority = tipoAuthority;
