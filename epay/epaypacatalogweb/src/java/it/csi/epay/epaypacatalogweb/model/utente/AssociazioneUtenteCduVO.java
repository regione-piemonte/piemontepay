...
public class AssociazioneUtenteCduVO implements Serializable {
    ...
    public String toString () {
        return "AssociazioneUtenteCduVO [id=" + id + ", codice=" + codice + ", codiceCategoria=" + codiceCategoria + ", descrizione=" + descrizione
