...
<form:form method="post"
	commandName="filtro_ricerca_utenti_af" 
	action="${context}/autorizzazione-funzioni/ricerca"
>
	<fieldset>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="form-group ">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label" for="descrizioneCategoriaCdu"><spring:message code="filter.categoriafunzione" /></label>
					<div class="col-xs-12 col-sm-9 col-md-4 controls">
						<form:input class="form-control input-filtro-categoria-funzione" path="descrizioneCategoriaCdu" />
						<form:hidden path="codiceCategoriaCdu" />
					</div>
					<div class="col-md-1 display-md-inline"></div>
					<label class="col-xs-12 col-sm-3 col-md-1 control-label" for="descrizioneCdu"><spring:message code="filter.nomefunzione" /></label>
					<div class="col-xs-12 col-sm-9 col-md-4 controls">
						<form:input class="form-control input-filtro-funzione" path="descrizioneCdu" />
						<form:hidden path="codiceCdu" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row-fluid">
			<p class="margin-medium">
				<a 
					...
					href="${context}/autorizzazione-funzioni/pulisci"
