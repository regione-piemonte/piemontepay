...
<div class ="col-sm-12">
	<table id="results" class="table table-hover tab_left dataTable no-footer">
		...
		<tbody>
			<c:forEach var="riga" items="${lista_risultati_af}">
			<tr id='view_<c:out value="${riga.id}" />'>
				...
				<td>
					<!-- SE SONO AMMINISTRATORE NON SI VISUALIZZANO AZIONI -->
					<c:if test="${not riga.admin}">
						<div id="tableRowActions" class="btn-group">
							...
							<ul class="dropdown-menu pull-right">
								<li>
									<a class="modificaAction" href="${context}/autorizzazione-funzioni/modifica/${riga.id}"  >
