	...
	<div class="banner">
		...
		<div class="row-fluid">
			<div class="span12">
				<ul class="breadcrumb">
					<li>
						<a href="${context}${webappConfig.epaypaHome}${webappConfig.requestParam}<sec:authentication property="principal.ente.codiceFiscale" />"><spring:message code="text.ritornahome" /></a> <span class="divider"></span>
					</li>
					<li class="active"><spring:message code="alert.accessdenied" /></li>
				</ul>
			</div>
		</div>
			...
			<div class="row-fluid">
				<div class="contentPage">
					...
					<div class="context container-fluid">
						<div class="row-fluid">
							<div class="contentPage">
								<spring:message code="alert.accessdenied" />
							</div>
