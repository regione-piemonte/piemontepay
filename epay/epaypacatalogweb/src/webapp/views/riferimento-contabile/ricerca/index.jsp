		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="contentPage">
					...
					<h3><spring:message code="riferimenticontabili.ricerca.title" /></h3>
			...
			<sec:authorize access="hasRole('INSERISCI_RIFERIMENTO_CONTABILE')">
				<div class="row-fluid" style="padding-bottom: 2em;">
					<p class="margin-medium">
						<a id="buttonNew" class="btn btn-primary btn-action" href="${context}/riferimenti-contabili/nuovo">
							<spring:message code="riferimenticontabili.action.inserisci" />
						</a> 
					</p>
				</div>
			</sec:authorize>
