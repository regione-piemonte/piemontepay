...
<div class="container-fluid">
	<div class="form-group ">
		...
		<div class="col-sm-10 controls">
			<form:input class="form-control view-uppercase input-codice-fiscale" path="codiceFiscale" />
		</div>
...
<div class="container-fluid">
	<div class="form-group ">
		...
		<div class="col-sm-10 controls">
			<form:input class="form-control input-nome" path="nome"/>
		</div>
		<div class="col-sm-2"></div>
		<div class="col-sm-10">
...
<div class="container-fluid">
	<div class="form-group ">
		...
		<div class="col-sm-10 controls">
			<form:input class="form-control input-cognome" path="cognome"/>
		</div>
		<div class="col-sm-2"></div>
		<div class="col-sm-10">
...
<div class="container-fluid">
	<div class="form-group ">
		...
		<div class="col-sm-10 controls">
			<form:input class="form-control input-email" path="email" />
		</div>
		<div class="col-sm-2"></div>
		<div class="col-sm-10">
...
<div class="container-fluid">
	<div class="form-group ">
		...
		<div class="col-sm-10 controls input-append">
			<form:input path="dataInizioValidita" id="dataInizioValidita" class="form-control datepicker input-data" />
		</div>
		<div class="col-sm-2"></div>
		<div class="col-sm-10">
