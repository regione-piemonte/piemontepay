...
<head>
	...
	<script type="text/javascript" src="${webappConfig.staticResourcesPath}/lib/jquery-ui.min.js"></script>
	<script type="text/javascript" src="${webappConfig.staticResourcesPath}/lib/validation.struts.min.js"></script>
	...
	<script type="text/javascript" src="${webappConfig.staticResourcesPath}/js/datatables/datatables.min.js"></script>
   	...
   	<script type="text/javascript" src="${webappConfig.staticResourcesPath}/js/datepicker/datepicker-it.js"></script>
    ...
    <link href="${webappConfig.staticResourcesPath}/css/jquery-ui.min.css" rel="stylesheet"/>    
    ...
    <script type="text/javascript" src="${webappConfig.staticResourcesPath}/js/formChangeTracker.js"></script>
</head>
