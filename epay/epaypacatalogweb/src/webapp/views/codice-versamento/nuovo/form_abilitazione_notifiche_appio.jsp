...
<div id = "formAbilitazioneIoappId"> 
...
<h4><spring:message code="index.abilitazione.appio" /></h4>
                                ...
                                <div class="container-fluid">
									...
									<div class="container-fluid">
										<div class="row-fluid">
											<div class="form-group " style="height: 20px;">
													<label class="col-sm-2 control-label" for="flagPersonalizzazioneCov">
									...
									<div class="container-fluid" id  = "opzioniAbilitazioneNotificheId" >
									  ...
									  <sec:authorize access="not (hasRole('ASSISTENZA') )">
                                                <form:hidden id="flagPersonalizzazioneCov" path="flagPersonalizzazioneCov" value = "false" />    
                                                <form:hidden id="descrizioneTextCov" path="descrizioneTextCov" />    
                                                </sec:authorize>
