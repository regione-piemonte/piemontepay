...
<c:set var="w05" value="2" />
	 ...
	 <p class="alert alert-warning">
			               <spring:message code="codiceversamento.modifica.alert.no.opzioni.ente.secondario" />
									...
									<div class="container-fluid">
										<div class="row-fluid">
											<div class="form-group " style="height: 20px;">
													<label class="col-sm-${w00} control-label" for="flagElementiMultibeneficiario">
									...
									<div class="container-fluid" id  = "elementiMultibeneficiarioId" >
										<div class="row-fluid">
											<div class="form-group ">	
											<label class="col-sm-${w00} control-label required"   for="modalitaAssociazioneMultibeneficiario"><spring:message code="modalitaAssociazioneMultibeneficiario" /></label>
									...
									<div class="container-fluid" id = "elementiMultibeneficiarioEnteId" >
										<div class="row-fluid">
											<div class="form-group ">	
											<label class="col-sm-${w00} control-label required"   for="enteSecondarioAssociazioneMultibeneficiario"><spring:message code="enteSecondarioAssociazioneMultibeneficiario" /></label>
												<div class="col-sm-${w01} controls">
									...
									<div class="container-fluid" id = "elementiMultibeneficiariorCovAssociatoId" >
										<div class="row-fluid">
											<div class="form-group ">	
											<label class="col-sm-${w00} control-label required"   for="covAssociatoAssociazioneMultibeneficiario"><spring:message code="covAssociatoAssociazioneMultibeneficiario" /></label>
												<div class="col-sm-${w01} controls">
