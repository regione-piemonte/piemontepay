...
<div class="container-fluid mb-1">
	<div class="row-fluid">
		<div class="form-group ">
			<label class="col-sm-${w00} control-label " for="codiceVoceEntrata"><spring:message code="codiceversamento.form.voceentratappay" /></label>
			<div class="col-sm-${w01} controls">
				<div class="input-group input-group-inline">
...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="form-group ">
			<label class="col-sm-${w00} control-label " for="codiceTipoPagamento"><spring:message code="tipopagamento" /></label>
			<div class="col-sm-${w01} controls">
