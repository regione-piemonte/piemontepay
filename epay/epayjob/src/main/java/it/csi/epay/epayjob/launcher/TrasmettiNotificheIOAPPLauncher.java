...
import it.csi.epay.epayjob.business.TrasmettiNotificheIOAPP;
...
/**
 * Batch per RDI-43: Batch per l'invio delle posizioni debitorie create all'app IO.
 */
public class TrasmettiNotificheIOAPPLauncher {
    ...
    public static void main ( String [] args ) throws Exception {
        ...
        try {
            context.infoStart ();
            TrasmettiNotificheIOAPP tnp = new TrasmettiNotificheIOAPP ( context, jobFacade );
            tnp.execute ();
