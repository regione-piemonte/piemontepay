...
import it.csi.epay.epayjob.business.TrasmettiNotificheTipizzateIOAPP;
...
/**
 * Batch per RDI-431: Batch per l'invio delle notifiche tipizzate create all'app IO.
 */
public class TrasmettiNotificheTipizzateIOAPPLauncher {
    ...
    public static void main ( String [] args ) throws Exception {
        ...
        try {
            context.infoStart ();
            TrasmettiNotificheTipizzateIOAPP tnp = new TrasmettiNotificheTipizzateIOAPP ( context, jobFacade , configurazioneFacade);
            tnp.execute ();
