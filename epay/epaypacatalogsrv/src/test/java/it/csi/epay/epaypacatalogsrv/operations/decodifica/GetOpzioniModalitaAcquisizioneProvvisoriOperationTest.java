...
@Transactional
public class GetOpzioniModalitaAcquisizioneProvvisoriOperationTest extends GetOpzioniParentOperationTest<GetOpzioniModalitaAcquisizioneProvvisoriOutput> {
