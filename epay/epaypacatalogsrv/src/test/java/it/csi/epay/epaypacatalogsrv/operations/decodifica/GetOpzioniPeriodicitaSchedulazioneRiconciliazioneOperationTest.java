...
@Transactional
public class GetOpzioniPeriodicitaSchedulazioneRiconciliazioneOperationTest extends GetOpzioniParentOperationTest<
                GetOpzioniPeriodicitaSchedulazioneRiconciliazioneOutput> {
