...
@Transactional
public class GetOpzioniTipologiaDatoSpecificoRiscossioneOperationTest extends GetOpzioniParentOperationTest<GetOpzioniTipologiaDatoSpecificoRiscossioneOutput> {
