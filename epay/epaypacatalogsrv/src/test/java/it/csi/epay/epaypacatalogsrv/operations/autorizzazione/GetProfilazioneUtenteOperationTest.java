...
@Transactional
public class GetProfilazioneUtenteOperationTest extends ParentOperationTest {
    ...
    private GetProfilazioneUtenteOutput call ( GetProfilazioneUtenteInput input ) {
        try {
            return getPort ().getProfilazioneUtente ( input );
    ...
    public void shouldReturnBadRequestWithoutCaller () {
        ...
        GetProfilazioneUtenteInput input = new GetProfilazioneUtenteInput ();
