...
public class DatoSpecificoRiscossioneOutput implements Serializable {
    ...
    private List<DatoSpecificoRiscossione> elencoDatiSpecifici;
     ...
     */
    public List<DatoSpecificoRiscossione> getElencoDatiSpecifici () {
     ...
     */
    public void setElencoDatiSpecifici ( List<DatoSpecificoRiscossione> elencoDatiSpecifici ) {
