...
public class RicercaRiferimentoContabileStoricoOutputDto implements Serializable {
    ...
    public String toString () {
        return "RicercaRiferimentoContabileStoricoOutputDto [id=" + id + ", annoAccertamento=" + annoAccertamento + ", annoEsercizio=" + annoEsercizio
