...
/**
 * The primary key class for the epaycat_r_utente_codice_versamento database table.
 * 
 */
@Embeddable
public class AssociazioneUtenteCodiceVersamentoPK implements Serializable {
	...
	public AssociazioneUtenteCodiceVersamentoPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof AssociazioneUtenteCodiceVersamentoPK)) {
			return false;
		}
		AssociazioneUtenteCodiceVersamentoPK castOther = (AssociazioneUtenteCodiceVersamentoPK)other;
		return 
	...
	public String toString() {
		return "AssociazioneUtenteCodiceVersamentoPK [idCodiceVersamento=" + idCodiceVersamento + ", idUtente="
				+ idUtente + ", idEnte=" + idEnte + "]";
	}
}
