...
/**
 * <p>Classe Java per spacchettaFlussoDaSpacchettareByEnteByIdentificativoFlussoResponse complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="spacchettaFlussoDaSpacchettareByEnteByIdentificativoFlussoResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "spacchettaFlussoDaSpacchettareByEnteByIdentificativoFlussoResponse", propOrder = {
    "result"
})
public class SpacchettaFlussoDaSpacchettareByEnteByIdentificativoFlussoResponse {
