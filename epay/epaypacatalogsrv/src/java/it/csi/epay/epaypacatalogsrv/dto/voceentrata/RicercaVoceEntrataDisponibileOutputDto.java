...
public class RicercaVoceEntrataDisponibileOutputDto implements Serializable {
    ...
    public String toString () {
        return "RicercaVoceEntrataDisponibileOutputDto [id=" + id + ", codice=" + codice + ", descrizione=" + descrizione + ", codiceMacrotipo="
            + codiceMacrotipo + ", codiceTematica=" + codiceTematica + ", descrizioneMacrotipo=" + descrizioneMacrotipo + ", descrizioneTematica="
            + descrizioneTematica + "]";
    }
