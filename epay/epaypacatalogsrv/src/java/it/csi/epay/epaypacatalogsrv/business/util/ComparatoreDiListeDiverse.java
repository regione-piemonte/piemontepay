...
public abstract class ComparatoreDiListeDiverse {
    ...
    public static <T1, T2>
        ...
        compareLists ( List<T1> list1, List<T2> list2, ComparatoreDiElementiDiversi<T1, T2> matcher )
    {
    ...
    public static class DifferenzaFraListeDiverse<T1, T2> {
        ...
        public DifferenzaFraListeDiverse() {
            inFirstNotInSecond = new ArrayList<>();
            inSecondNotInFirst = new ArrayList<>();
            inBothFromFirst = new ArrayList<>();
            inBothFromSecond = new ArrayList<>();
