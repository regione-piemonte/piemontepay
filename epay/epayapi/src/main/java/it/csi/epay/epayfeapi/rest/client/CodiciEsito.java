...
public enum CodiciEsito {
	...
	POSIZIONI_DEBITORIE_IMPORTO_NULLO ( "156",
					"Impossibile eseguire l'operazione: in una o piu' posizioni debitorie l'elemento ImportoTotale non e' presente oppure non e' valorizzato" ),
	...
	PAGAMENTO_NON_TROVATO_PER_POSIZIONE_DEBITORIA ( "176",
					"Posizione debitoria non trovata per C.F ente $0, codice versamento $1, id posizione debitoria $2." ),
	PAGAMENTO_NON_TROVATO_PER_IDENTIFICATIVO_PAGAMENTO ( "176",
					"Posizione debitoria non trovata per C.F ente $0, codice versamento $1, identificativo pagamento $2." ),
	...
	ERRORE_TOTALE_IMPORTO_COMPONENTI ( "184",
					"ImportoTotale ($3 Euro) differente dalla somma degli importi delle componenti ($4 Euro) del pagamento per IdPosizioneDebitoria $2, ente con C.F. $0 e CodiceVersamento $1 " ),
	ERRORE_DATE_VALIDITA ( "185",
					"Incongruenza nelle date di validita' per il pagamento con IdPosizioneDebitoria $2, ente con C.F. $0 e CodiceVersamento $1 " ),
