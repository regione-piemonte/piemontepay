...
import it.csi.epay.epayapi.api.interceptors.RequestLoggingInterceptor;
...
import it.csi.epay.epayapi.dto.common.ErrorMessageDTO;
import it.csi.epay.epayapi.dto.common.MessaggioDTO;
import it.csi.epay.epayapi.dto.exception.ConflictException;
...
public class ErrorHandlerApiImpl implements ExceptionMapper<Exception> {
    ...
    private static final Logger logger = LogManager.getLogger ( ErrorHandlerApiImpl.class );
