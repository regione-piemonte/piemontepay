...
import it.csi.epay.epayapi.business.MonitoringService;
import it.csi.epay.epayapi.dto.monitoring.ServiceStatus;
...
import it.csi.epay.epayapi.util.Monitorable;


@Service
public class MonitoringServiceImpl implements MonitoringService, ApplicationContextAware {

    private final Logger logger = LogManager.getLogger ( MonitoringService.class );
    ...
    private ServiceStatusDTO aggregate ( Map<Monitorable, ServiceStatusDTO> statuses, long time ) {
        ...
        return ServiceStatusDTO.builder ()
            .withName ( "Epayapi Service Status" )
    ...
    private ServiceStatusDTO checkDatabaseConnectionStatusLight () {
        ...
        EpayDChiamanteEsternoRepository repo = applicationContext.getBean ( EpayDChiamanteEsternoRepository.class );
    ...
    private ServiceStatusDTO checkFileSystemResourcesStatus () {
        ...
        if ( maxMemoryRaw.equals ( Long.MAX_VALUE ) ) {
            maxMemoryRaw = null;
        }
