...
import it.csi.epay.epayapi.integration.repository.EpayTParametriRepository;
import it.csi.epay.epayapi.util.Constants;
import it.csi.epay.epayapi.util.Environments;
import it.csi.epay.epayapi.util.ParametriApplicativo;
import it.csi.epay.epayapi.util.ParametriApplicativo.ExposurePolicy;
...
public class ConfigurazioneServiceImpl implements ConfigurazioneService, InitializingBean {
    ...
    private final static Logger logger = LogManager.getLogger ( ConfigurazioneService.class );
    ...
    private static final String DB_GROUP = "epayapi";

    @Autowired
    private EpayTParametriRepository parametroApplicativoRepository;
    ...
    public Map<String, Object> getBuildProperties () {
        ...
        if ( !isTest ) {
            ...
            output.put ( "prodotto", "epay" );
            output.put ( "componente", "epayapi" );
