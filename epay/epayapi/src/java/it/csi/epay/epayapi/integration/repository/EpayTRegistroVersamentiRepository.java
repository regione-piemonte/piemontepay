...
/**
 * Spring data Jpa repository for "EpayTRegistroVersamenti" <br>
 *
 * @author fabio.fenoglio
 */
@SuppressWarnings ( "unused" )
@Repository
public interface EpayTRegistroVersamentiRepository extends IRepository<EpayTRegistroVersamenti, Long> {
}
