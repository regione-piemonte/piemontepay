...
import it.csi.epay.epayapi.api.util.pdf.BarcodeQRCode;
import it.csi.epay.epayapi.api.util.pdf.qrcode.EncodeHintType;
import it.csi.epay.epayapi.api.util.pdf.qrcode.ErrorCorrectionLevel;
import it.csi.epay.epayapi.api.util.pdf.qrcode.WriterException;
import it.csi.epay.epayapi.dto.v1.AvvisoPagamentoDTO;
...
public class AvvisoPagamentoPdfGenerator {
	...
	private static final Logger logger = LogManager.getLogger ( AvvisoPagamentoPdfGenerator.class );
	...
	public byte[] creaPdf ( EnteCreditoreAvvisoPagamentoDTO ente, DestinatarioAvvisoPagamentoDTO destinatarioAvviso,
		...
		ArrayList<AvvisoPagamentoDTO> avvisoAnalogicoList = null;
		try {
