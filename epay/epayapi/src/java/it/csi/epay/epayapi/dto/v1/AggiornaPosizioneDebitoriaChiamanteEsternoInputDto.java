...
public class AggiornaPosizioneDebitoriaChiamanteEsternoInputDto implements Serializable {
    ...
    public AggiornaPosizioneDebitoriaChiamanteEsternoInput getAggiornaPosizioneDebitoriaChiamanteEsternoInput ( String organization, String paymentType,
        String iuv ) {
        ...
        input.setRiferimentiPagamento ( this.riferimentiPagamento );
        input.setIdentificativoPagamento ( this.identificativoPagamento );
        ...
        } else if ( StringUtils.hasText ( this.cognome ) ||  StringUtils.hasText ( this.nome ) ) {
    ...
    public String toString () {
        return "AggiornaPosizioneDebitoriaChiamanteEsternoInputDto{" +
            ...
            ", riferimentiPagamento=" + riferimentiPagamento +
            '}';
    }
}
