...
public class SpringApplicationContextHelper implements ApplicationContextAware {
    ...
    private static final Logger logger = LogManager.getLogger ( SpringApplicationContextHelper.class );
    ...
    private static final Map<Object, Boolean> injectionStatus = new HashMap<> ();
