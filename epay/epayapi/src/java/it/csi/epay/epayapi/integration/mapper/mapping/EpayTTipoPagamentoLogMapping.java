...
import it.csi.epay.epayapi.integration.dto.EpayTTipoPagamentoLogDTO;
...
public interface EpayTTipoPagamentoLogMapping {
    ...
    EpayTTipoPagamentoLogDTO toDTO ( EpayTTipoPagamentoLog input );
