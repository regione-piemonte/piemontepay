...
/**
 * Spring data Jpa repository for "EpayTTipoPagamentoLog" <br>
 *
 * @author fabio.fenoglio
 */
@SuppressWarnings ( "unused" )
@Repository
public interface EpayTTipoPagamentoLogRepository extends IRepository<EpayTTipoPagamentoLog, Long> {
}
