...
/**
 * Reference DTO for entity "epay_t_transazione_mdp" <br>
 ...
 *
 */
public class EpayTTransazioneMdpReferenceDTO implements Serializable {

    private static final long serialVersionUID = 1L;

    @NotNull
    @Size( min = 1, max = 50 )
    private String idTransazione ; // String // Id or Primary Key

    @NotNull
    @Size( min = 1, max = 25 )
    private String iuv ;  // String 
    @Size( max = 50 )
    private String idGateway ;  // String 
    @Size( max = 50 )
    private String idPaymentMode ;  // String 

    private Integer idInformativaPsp ;  // Integer 
    @Size( max = 250 )
    private String identificativoPsp ;  // String 
    @Size( max = 250 )
    private String ragioneSocialePsp ;  // String 
    @Size( max = 250 )
    private String identificativoCanalePsp ;  // String 
    @Size( max = 250 )
    private String tipoVersamentoPsp ;  // String 

    private Integer modelloPagamentoPsp ;  // Integer 

    /**
     * Default constructor
     */
    public EpayTTransazioneMdpReferenceDTO() {
        super();
    }
