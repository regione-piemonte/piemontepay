...
import it.csi.epay.epayapi.integration.domain.EpayTRt;
import it.csi.epay.epayapi.integration.dto.EpayTRtReferenceDTO;
...
public interface EpayTRtReferenceMapping {
    ...
    EpayTRtReferenceDTO toDTO ( EpayTRt input );
