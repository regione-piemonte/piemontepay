...
public class DestinatarioAvvisoPagamentoDTO implements Serializable {
	...
	private static final long serialVersionUID = -8493866842062236922L;
	...
	@Override public String toString () {
		return "DestinatarioAvvisoPagamentoDTO{" +
						"idUnivocoDestinatario='" + idUnivocoDestinatario + '\'' +
						", anagraficaDestinatario='" + anagraficaDestinatario + '\'' +
