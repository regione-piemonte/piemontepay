...
/**
 * DTO for entity "epay_t_enti_temp" <br>
 ...
 *
 */
public class EpayTEntiTempDTO implements Serializable {

    private static final long serialVersionUID = 1L;

    @NotNull
    private Long idEnteTemp ; // Id or Primary Key
