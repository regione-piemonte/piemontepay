...
/**
 * Reference DTO for entity "epay_d_chiamante_esterno" <br>
 ...
 *
 */
public class EpayDChiamanteEsternoReferenceDTO implements Serializable {
    ...
    @Size( max = 200 )
    private String descrizioneChiamante ;  // String 
    @NotNull
    private Date dataInizioValidita ;  // Date 

    private Date dataFineValidita ;  // Date 

    /**
     * Default constructor
     */
    public EpayDChiamanteEsternoReferenceDTO() {
        super();
    }
