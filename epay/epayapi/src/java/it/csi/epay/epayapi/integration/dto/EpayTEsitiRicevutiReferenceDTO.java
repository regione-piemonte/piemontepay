...
/**
 * Reference DTO for entity "epay_t_esiti_ricevuti" <br>
 ...
 *
 */
public class EpayTEsitiRicevutiReferenceDTO implements Serializable {

    private static final long serialVersionUID = 1L;

    @NotNull
    private Long idEsito ; // Long // Id or Primary Key

    @NotNull
    private Integer idModalitaRicezione ;  // Integer 
    @Size( max = 30 )
    ...
    @Size( max = 35 )
    private String iur ;  // String 

    /**
     * Default constructor
     */
    public EpayTEsitiRicevutiReferenceDTO() {
        super();
    }
