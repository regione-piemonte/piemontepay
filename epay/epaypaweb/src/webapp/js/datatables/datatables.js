...
(function( $, window, document, undefined ) {
	...
	{
		_fnCompatMap( init, 'sorting',      'bSort' );
	 ...
	 *  @param {string} [json.sColumns] Column sorting (sName, comma separated)
	 *  @memberof DataTable#oApi
	 */
	...
	function _fnScrollDraw ( settings )
	{
		...
		// Correct DOM sorting for colgroup - comes before the thead
	...
	/**
	 * Get current sorting (sorting) that has been applied to the table.
	 *
	...
	DataTable.defaults.column = {
		 ...
		 * HTML tags before sorting)) are currently available. Note that only date
	...
	DataTable.ext = _ext = {
		 ...
		 * wish to be sorting for the column in question and then return that
		 * array. The data in the array much be in the index order of the rows in
		 * the table (not the currently sorting order!). Which order data gathering
		 ...
		 *
		 * * `{array}` Data for the column to be sorting upon
		 *
		 *  @type array
		 *
		 *  @example
		 ...
		 * The type of a column will effect how it is sorting and search (plug-ins
	...
	/**
	 * Order event, fired when the sorting applied to the table is altered.
