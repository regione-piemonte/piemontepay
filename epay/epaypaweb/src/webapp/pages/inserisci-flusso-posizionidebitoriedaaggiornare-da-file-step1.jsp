...
<body>
	...
	<div class="row-fluid">
		<div class="span12">
			<ul class="breadcrumb">
				...
				<li class="active">Inserisci lista aggiornamento posizioni debitorie da file (Passo 1 di 2)</li>
			</ul>
		</div>
	</div>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="contentPage">
				<s:form method="POST" action="inserisci-flusso-posizionidebitoriedaaggiornare-da-file-step1" theme="bootstrap" cssClass="form-horizontal">
					<%@ include file="../include/validation-message.jsp"%>

					<h3>Inserisci lista aggiornamento posizioni debitorie da file (Passo 1 di 2)</h3>
					...
					<div class="step-content">
						<div class="step-pane active" id="templateDownloadPanel">
							...
							<div id="collapseTemplateDownloadPanel" class="collapse in">
								<div class="row-fluid">
									<p>Scarica il template per preparare la lista di aggiornamento, scegli il formato.</p>
									<p class="margin-medium">
										<s:a action="download-template" cssClass="btn">
											...
											<s:param name="templateProperty">template.flusso.posizionidebitoriedaaggiornare.filename.csv</s:param>
										...
										<s:a action="download-template" cssClass="btn">
											...
											<s:param name="templateProperty">template.flusso.posizionidebitoriedaaggiornare.filename.xslx</s:param>
					...
					<div class="step-content">
						<div class="step-pane active">
							...
							<div class="row-fluid">
								<p class="margin-medium">
									<s:a action="entry-inserisci-flusso-posizionidebitoriedaaggiornare-da-file-step1" cssClass="btn" id="formSubmitButtonPulisci">
										Pulisci
	...
	<script src="js/epaypaweb/inserisci-flusso-posizionidebitoriedaaggiornare-da-file-step1.js" type="text/javascript"></script>
