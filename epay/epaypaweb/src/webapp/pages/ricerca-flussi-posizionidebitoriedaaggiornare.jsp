...
<body>
	...
	<div class="row-fluid">
		<div class="span12">
			<ul class="breadcrumb">
				...
				<li class="active">Ricerca liste aggiornamento posizioni debitorie</li>
			</ul>
		</div>
	</div>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="contentPage">
				<s:set var="pageTitle">Ricerca liste aggiornamento posizioni debitorie</s:set>
				...
				<div class="margin-medium">
					<s:form action="entry-visualizza-flusso-posizionidebitoriedaaggiornare.do" method="POST" theme="simple">
						...
						<s:if test="isUseCaseEnabled('INS_AGPD')">
							...
							<s:submit value="Nuovo lista aggiornamento posizioni debitorie" cssClass="btn btn-primary pull-right"/>
						</s:if>
					</s:form>
				</div>
			</div>
	...
	<s:form id="visualizzaFlussoForm" action="entry-visualizza-flusso-posizionidebitoriedaaggiornare.do" method="POST" theme="simple">
		<s:hidden name="idFlusso"/>
		<s:hidden name="init" value="true"/>
		<s:hidden name="operativita" value="VISUALIZZA"/>
	</s:form>
	<s:form id="modificaFlussoForm" action="modifica-flusso-posizionidebitoriedaaggiornare.do" method="POST" theme="simple">
		<s:hidden name="idFlusso"/>
		<s:hidden name="init" value="true"/>
	...
	<s:form id="scaricaCSVForm" action="scarica-flusso-posizionidebitoriedaaggiornare.do" method="POST" theme="simple">
		<s:hidden name="idFlusso"/>
		<s:hidden name="tipoFormato" value="CSV"/>
		<s:hidden name="pleaseWaitTokenValue"/>
	</s:form>
	<s:form id="scaricaExcelForm" action="scarica-flusso-posizionidebitoriedaaggiornare.do" method="POST" theme="simple">
		<s:hidden name="idFlusso"/>
	...
	<script src="js/epaypaweb/ricerca-flussi-posizionidebitoriedaaggiornare.js" type="text/javascript"></script>
