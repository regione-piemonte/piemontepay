...
public class LogAndWatch {
	...
	public LogAndWatch(org.apache.logging.log4j.Logger log, String className, String methodName) {
		this(log, className, methodName, true);
	}

	public LogAndWatch(org.apache.logging.log4j.Logger log, String className, String methodName, boolean isWatchEnabled) {
		this.log = log;
	...
	public LogAndWatch(java.util.logging.Logger log, String className, String methodName, boolean isWatchEnabled) {
		this.log = LogManager.getLogger (LogAndWatch.class);
		this.className = className;
		this.methodName = methodName;
		this.startLogpx = buildLogpx(className, methodName);
		this.stopLogpx = buildLogpx(className, methodName);
