...
public class StatoReportDto implements Serializable {
     ...
     * 
     */
    public StatoReportDto () {
        super ();
    }


    @Generated ( "SparkTools" )
    private StatoReportDto ( Builder builder ) {
        this.id = builder.id;
    ...
    /**
     * Creates builder to build {@link StatoReportDto}.
    ...
    /**
     * Builder to build {@link StatoReportDto}.
     */
    @Generated ( "SparkTools" )
    public static final class Builder {
        ...
        public StatoReportDto build () {
            return new StatoReportDto ( this );
        }
    }
