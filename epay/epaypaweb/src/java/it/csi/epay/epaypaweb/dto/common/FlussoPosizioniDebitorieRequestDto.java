...
public class FlussoPosizioniDebitorieRequestDto extends PrincipalDto {

	private static final long serialVersionUID = 1L;
	
	private Long idFlusso;

	public FlussoPosizioniDebitorieRequestDto(String ipAddress,  Long idUtente, String codiceFiscaleUtente,
