...
import it.csi.epay.epaypaweb.facade.cooppec.dto.ResultType;
...
import it.csi.epay.epaypaweb.facade.cooppec.service.CoopApplicativaPEC;
import it.csi.epay.epaypaweb.util.CostantiErrori;

@Stateless
@WebService(name = "CoopApplicativaPEC", serviceName="CoopApplicativaPEC", portName = "CoopApplicativaPEC", targetNamespace = "http://www.csi.it/epay/epaywso/coopapplicativapec")
@TransactionManagement(TransactionManagementType.CONTAINER)
public class CoopApplicativaPECImpl extends EPaypaFacadeBase implements CoopApplicativaPEC {
