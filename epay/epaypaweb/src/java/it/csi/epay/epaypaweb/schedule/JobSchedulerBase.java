...
import it.csi.epay.epaypaweb.schedule.plan.SchedulePlan;
import it.csi.epay.epaypaweb.schedule.plan.SchedulePlanConfig;
import it.csi.epay.epaypaweb.schedule.plan.TimeInterval;
...
public class JobSchedulerBase {
	...
	protected ScheduleExpression buildScheduleExpression(String cronExpression) throws IllegalArgumentException {
		...
		if (schedulePart == null || schedulePart.length == 0)
