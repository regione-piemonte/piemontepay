...
public class RegistraEsitoInserimentoListaDiCaricoRequestDto extends PrincipalDto {

	private static final long serialVersionUID = 1L;

	private EsitoPosizioniDebitorieDto esitoDto;

	public RegistraEsitoInserimentoListaDiCaricoRequestDto(String ipAddress, Long idUtente, String codiceFiscaleUtente,
			String codiceApplicazione, EsitoPosizioniDebitorieDto esitoDto) {
