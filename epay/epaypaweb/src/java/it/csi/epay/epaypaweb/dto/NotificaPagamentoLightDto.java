...
public class NotificaPagamentoLightDto extends ElementoFlussoDto implements Serializable {
	...
	public NotificaPagamentoLightDto() {
		super();
	}

	public NotificaPagamentoLightDto(Long id) {
		super(id);
	}
