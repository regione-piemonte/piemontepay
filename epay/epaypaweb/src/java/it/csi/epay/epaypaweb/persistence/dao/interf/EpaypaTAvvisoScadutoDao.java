...
//@formatter:off
public interface EpaypaTAvvisoScadutoDao extends EpaypaDaoBase<Long, EpaypaTAvvisoScaduto> {
	...
	public List<EpaypaTAvvisoScaduto> findAllByIdFlusso(Long idFlusso, List<CriterioOrdinamentoDto<ColumnNameAvvisoScadutoEnum>> ord, PaginazioneDto pag) throws PersistenceException;
