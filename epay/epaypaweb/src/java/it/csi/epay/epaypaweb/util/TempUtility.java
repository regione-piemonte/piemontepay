...
import it.csi.epay.epaypaweb.facade.cooppec.dto.CodiceVersamentoType;
import it.csi.epay.epaypaweb.facade.cooppec.dto.ModalitaDiIntegrazioneType;
import it.csi.epay.epaypaweb.facade.cooppec.dto.RiferimentoContabileType;
import it.csi.epay.epaypaweb.facade.cooppec.dto.TipoMultibeneficiarioType;
...
public interface TempUtility {
    ...
    public static EpaypaTEnte buildEnte ( EpaypaTEnteTemp enteTemp ) {
        EpaypaTEnte ente = new EpaypaTEnte ();
        ...
        ente.setCodGs1Gln ( enteTemp.getCodGs1Gln () );
        ente.setCodInterbancario ( enteTemp.getCodInterbancario () );
    ...
    public static EpaypaTEnteTemp buildEnteTemp ( AggiornaEnteRequest aggiornaEnteRequest ) {
        EpaypaTEnteTemp enteTemp = new EpaypaTEnteTemp ();
        ...
        enteTemp.setCodGs1Gln ( aggiornaEnteRequest.getEnte ().getGs1Gln () );
        enteTemp.setCodInterbancario ( aggiornaEnteRequest.getEnte ().getCbill () );
        enteTemp.setLogo ( aggiornaEnteRequest.getEnte ().getLogo () );
    ...
    public static List<EpaypaTCodiceVersamentoTemp> creaCodiciVersamento ( EpaypaTEnteTemp enteTemp, List<String> codiciRiferimento ) {
        List<EpaypaTCodiceVersamentoTemp> codiceVersamentoList = new ArrayList<> ();
        for ( String codiceRiferimento: codiciRiferimento ) {
            EpaypaTCodiceVersamentoTemp codiceVersamentoTemp = new EpaypaTCodiceVersamentoTemp ();
    ...
    static EpaypaTCodiceVersamentoTemp createCodiceVersamento ( EpaypaTEnte enteEntity, CodiceVersamentoType codiceVersamento, String azione,
        String idOperazione, EpaypaDTipoPagamento tipoPagamento )
                    throws CoopPecException {
        EpaypaTCodiceVersamentoTemp entity = new EpaypaTCodiceVersamentoTemp ();
        ...
        entity.setBollettinoPostale(codiceVersamento.isFlagPresenzaBollettinoPostale());
        ...
        // RDI 02 2019
        entity.setIdTipoPagamento ( tipoPagamento != null ? tipoPagamento.getId () : null );
        
        
//        RDI-45 
        
       
        entity.setFlagMbPrimario ( TipoMultibeneficiarioType.PRIMARIO.equals ( codiceVersamento.getTipoMultibeneficiario () ));
        entity.setFlagMbSecondario ( TipoMultibeneficiarioType.SECONDARIO.equals ( codiceVersamento.getTipoMultibeneficiario () ));

        return entity;
    }

    public static List<EpaypaTCodiceVersamento> elaboraCodiciVersamento ( List<EpaypaTCodiceVersamento> codiceVersamentoList,
        List<EpaypaTCodiceVersamentoTemp> codiceVersamentoTempList ) {
        List<EpaypaTCodiceVersamento> codiceVersamentoListcatalogsToUpdate = new ArrayList<> ();
        if ( null != codiceVersamentoList && !codiceVersamentoList.isEmpty () ) {
            ...
            if ( null != codiceVersamentoTempList && !codiceVersamentoTempList.isEmpty () ) {
                ...
                for ( EpaypaTCodiceVersamento codiceVersamento: codiceVersamentoList ) {
    ...
    static EpaypaTCodiceVersamento mapCblTCodiceVersamentoSenzaIdEnte ( EpaypaTCodiceVersamento codiceVersamento, EpaypaTCodiceVersamentoTemp codiceVersamentoTemp ) {
        ...
        codiceVersamento.setIdTipoPagamento ( codiceVersamentoTemp.getIdTipoPagamento () );
        codiceVersamento.setFlagMbPrimario ( codiceVersamentoTemp.getFlagMbPrimario () );
        codiceVersamento.setFlagMbSecondario ( codiceVersamentoTemp.getFlagMbSecondario () );

        codiceVersamento.setBollettinoPostale(codiceVersamentoTemp.getBollettinoPostale());
