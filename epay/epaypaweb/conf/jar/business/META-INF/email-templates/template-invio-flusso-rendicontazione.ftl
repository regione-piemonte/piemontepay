...
<body>
	<p>Flusso estratto dal motore dei pagamenti alle ore ${flusso.dataInserimento?time} del giorno ${flusso.dataInserimento?date}.</p>

	<p>Il file <b>${filename}</b>, allegato alla presente e-mail,
	contiene n. <b>${flusso.numeroElementi}</b> ${flusso.desTipoFlusso?lower_case} pagamenti 
