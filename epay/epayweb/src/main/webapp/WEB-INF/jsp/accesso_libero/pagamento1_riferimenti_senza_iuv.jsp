	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<form:form id="form" class="form-horizontal" method="POST" action="${urlRiferimenti}" modelAttribute="riferimento">
					<div class="row">
						<div class="col-sm-12 col-md-6 col-lg-6">
							<div class="form-group">
								<form:label path="enteId" cssClass="control-label" cssErrorClass="control-label has-error">* Ente</form:label>
								<a tabindex="0" data-toggle="popover" data-trigger="focus"
									data-html="true"
									data-content="Il filtro 'Ente' prevede il suggerimento degli Enti disponibili a partire dal terzo carattere digitato all&rsquo;interno del campo.<br /><br />Una volta selezionato l&rsquo;Ente, verra' abilitato anche il filtro successivo dedicato ai 'Pagamenti' (utilizzabile sia come il filtro precedente con il suggerimento a partire dal terzo carattere sia come menu a tendina selezionando l&rsquo;apposita freccia presente all&rsquo;interno del campo)">
									<i class="fa fa-question-circle-o"></i>
								</a>
								<form:input path="enteId" cssClass="form-control" cssErrorClass="form-control has-error" type="hidden" />
								<input id="enteView" class="form-control" />
								<form:errors path="enteId" cssClass="help-block has-error" element="small" />
							</div>
							<span id="enteMessage"></span>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-12 col-md-6 col-lg-6">
							<div class="form-group">
								<form:label path="pagamentoId" cssClass="control-label"	cssErrorClass="control-label has-error">* Pagamento</form:label>
								<input type="hidden" id="oldPagamentoId" value="${riferimento.pagamentoId}" />
								<div class="input-group" style="z-index: 0;">
									<input id="pagamentoView" class="form-control" cssErrorClass="form-control has-error" />
									<form:input path="pagamentoId" cssClass="form-control" cssErrorClass="form-control has-error" type="hidden" />
								...
								<form:errors path="pagamentoId" cssClass="help-block has-error" element="small" />
							</div>
							<span id="pagamentoMessage"></span>
						</div>
					</div>
