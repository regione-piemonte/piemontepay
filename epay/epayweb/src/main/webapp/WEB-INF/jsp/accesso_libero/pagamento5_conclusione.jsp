...
<body class="interna">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="${messaggi.firstMessage.level.cssMsgClass}">
					...
					<p>
						Siamo in attesa di ricevere la Ricevuta Telematica contenente l'esito della transazione di pagamento. <br />La comunicazione
						dell'esito e la Ricevuta Telematica saranno inviati alla casella di posta che ci hai indicato: "
		...
		<c:if test="${not empty urlChiamanteEsterno}">
			<div class="row">
			<div class="col-sm-12">
				<div class="form-group pulsantiera">

					<a class="btn btn-default" id="action_indietro"
						href="${urlChiamanteEsterno}"> <i class="fa fa-chevron-left"
						aria-hidden="true"></i> Torna al sistema chiamante
					</a>
