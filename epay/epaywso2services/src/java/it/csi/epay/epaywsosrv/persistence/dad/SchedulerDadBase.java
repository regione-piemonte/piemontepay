...
public class SchedulerDadBase {
	...
	protected JobDto toJobDto(EPaywsoTScheduledJob entity) {
		JobDto dto = null;
	...
	protected List<JobDto> toScheduledJobDtoList(List<EPaywsoTScheduledJob> scheduledJobList) {
		List<JobDto> dtoList = null;

		if (scheduledJobList != null) {
			dtoList = new ArrayList<JobDto>();
			for (EPaywsoTScheduledJob entity : scheduledJobList) {
