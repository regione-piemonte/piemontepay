...
<form:form 
	id="filtro_ricerca_flussi"
	name="filtro_ricerca_flussi"
	action="${context}/flussi/ricerca" 
	method="post"
	class="" 
	modelAttribute="filtro_ricerca_flussi"
>
	<fieldset>

		<div id="alert-div"></div>

		<h3><spring:message code="flusso.formricerca.ricercaflussi" /></h3>
				...
				<div class="container-fluid">
					...
					<div class="row-fluid">
						<p class="margin-medium">
							<a id="formSubmitButtonPulisci" href="${context}/flussi/pulisci"
