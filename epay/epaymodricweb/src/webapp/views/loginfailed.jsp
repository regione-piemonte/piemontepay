		...
		<div class="row-fluid">
			<div class="span12">
				<ul class="breadcrumb">
					...
					<li class="active"><spring:message code="loginfailed.accessonegato" /></li>
				</ul>
			</div>
		</div>
				...
				<div class="contentPage">
					...
					<div class="context container-fluid">
						<div class="row-fluid">
							...
							<a class="btn btn-default" href="www.sistemapiemonte.it/cms/privati/"><spring:message code="loginfailed.ritornaalportale" /></a>
						</div>
					</div>
					<br />
				</div>
