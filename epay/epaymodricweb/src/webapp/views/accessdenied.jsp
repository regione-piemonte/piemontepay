		...
		<div class="row-fluid">
			<div class="span12">
				<ul class="breadcrumb">
					...
					<li class="active"><spring:message code="accessdenied.accessonegato" /></li>
				</ul>
			</div>
		</div>
			...
			<div class="row-fluid">
				<div class="contentPage">
					...
					<div class="context container-fluid">
						<div class="row-fluid">
							<div class="contentPage">
								<spring:message code="accessdenied.accessonegato" />
							</div>
							
							<a class="btn btn-default" href="${context}${webappConfig.epaypaHome}${webappConfig.requestParam}<sec:authentication property="principal.ente.codiceFiscale" />">Ritorna alla home</a>
						</div>
					</div>
					<br />
				</div>
