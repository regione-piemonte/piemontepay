	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><spring:message code="portal.info"/></h4>
			</div>
...
<div class="modal fade" id="modal-info" tabindex="-1" role="dialog" aria-labelledby="modal-info-label">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" data-dismiss="modal" id="modal-info-button-ok"><spring:message code="button.ok"/></button>
			</div>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><spring:message code="portal.informazione"/></h4>
			</div>
			<div class="modal-body">
				<!-- text here -->
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" data-dismiss="modal" id="commonModalButtonOK">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><spring:message code="portal.confermaeliminazione"/></h4>
			</div>
			<div class="modal-body">
				<spring:message code="portal.confermaoperazione"/>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" id="commonModalButtonCancel">
					<spring:message code="button.cancel"/>
				</button>
				<button type="button" class="btn btn-danger" id="commonModalButtonOK">
					<span class="glyphicon glyphicon-trash"></span> 
					<spring:message code="portal.confermaeliminazione"/>
				</button>
			</div>
		</div>
	</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><spring:message code="portal.confermaazione"/></h4>
			</div>
			<div class="modal-body">
				<spring:message code="portal.confermaoperazione"/>
			</div>
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" id="commonModalButtonOK">
					<span class="glyphicon glyphicon-share-alt"></span> 
					<spring:message code="button.procedi"/>
				</button>
			</div>
		</div>
	</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="confirm-action-label"><spring:message code="portal.confermaazione"/></h4>
			</div>
			...
			<div class="modal-footer">
				...
				<button type="button" id="confirm-action-button" class="btn btn-primary"><spring:message code="button.ok"/></button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="modal-pleasewait" tabindex="-1" role="dialog" aria-labelledby="header-title-label" data-keyboard="false">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="header-title-label"><spring:message code="portal.messaggioattesa"/></h4>
			</div>
...
function showModal(type, options, callbackProceed, callbackCancel, callbackFinal) {
	...
	if (options.text) spawnedModal.find(".modal-body").html(options.text);
	...
	if (options.buttons) {
		$.each(options.buttons, function(i, button) {
			...
			var b = $('<button type="button" class="btn" id="generatedModalButton' + button.id 
