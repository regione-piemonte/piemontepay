...
<div class="table-responsive">
	<table id="results" class="table table-hover tab_left dataTable no-footer">
		<thead>
		<tr>
			<th><spring:message code="flusso.tabelladettagli.cfpagatore" /></th>
			<th><spring:message code="flusso.tabelladettagli.anagpagatore" /></th>
			<th><spring:message code="flusso.tabelladettagli.causale" /></th>
			<th><spring:message code="flusso.tabelladettagli.codversamento" /></th>
			<th><spring:message code="flusso.tabelladettagli.importoversamento" /></th>
			<th><spring:message code="flusso.tabelladettagli.descrizioneversamento" /></th>
			<th><spring:message code="flusso.tabelladettagli.iuv" /></th>
			<th><spring:message code="flusso.tabelladettagli.indiceversamento" /></th>
			<th><spring:message code="flusso.tabelladettagli.esitopagamento" /></th>
			<th><spring:message code="flusso.tabelladettagli.datapagamento" /></th>
			<th><spring:message code="flusso.tabelladettagli.idtransazione" /></th>
			<th><spring:message code="flusso.tabelladettagli.datidiriscossione" /></th>
			<th><spring:message code="flusso.tabelladettagli.idunicoriscossione" /></th>
			<th><spring:message code="flusso.tabelladettagli.statoinviofruitore" /></th>
		...
		<tbody>
			...
			<tr>
				<td data-key="codiceFiscalePagatore">
					<c:out value="${result.codiceFiscalePagatore}">--</c:out>
				</td>
				...
				<td>
					<div id="tableRowActions" class="btn-group">
						...
						<ul class="dropdown-menu pull-right">
							<li>
								<a href="${context}/flussi/${flusso_origine_id}/sintesi/${dettaglio_flusso.flussoSintesi.id}/dettagli/${result.id}" 
									id="visualizzaFlussoDettaglioAction"
								>
									<spring:message code="flusso.tabelladettagli.visualizzadettaglio" />
								</a>
							</li>
						</ul>
					</div>
