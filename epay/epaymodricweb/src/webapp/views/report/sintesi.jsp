	...
	<div class="row-fluid">
		<div class="span12">
			<ul class="breadcrumb">
				...
				<li>
					<a href="${context}/flussi/ricerca"><spring:message code="flusso.sintesi.ricercaflussidiorigine" /></a>
					<span class="divider"></span>
				</li>
				<li class="active"><spring:message code="flusso.sintesi.flussidisintesi" /></li>
			</ul>
		</div>
	</div>
						...
						<div class="row">
							<c:if test="${not empty sintesi_flusso_errore}">
								<p class="alert alert-danger">
									<spring:message code="flusso.sintesi.errornelcaricamentoflussi" />
									<br/><br/>
							...
							<c:if test="${empty sintesi_flusso_errore}">
								...
								<h3><spring:message code="flusso.sintesi.flussidisintesi" /></h3>
								...
								<div style="margin-top: 1em;">
									<c:if test="${empty sintesi_flusso.flussiSintesi}">
										<p class="alert alert-info">
											<spring:message code="flusso.sintesi.nessunflussodisintesipresente" />
										</p>
									</c:if>
