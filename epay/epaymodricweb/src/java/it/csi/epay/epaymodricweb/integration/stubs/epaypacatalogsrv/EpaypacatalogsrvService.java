...
public class EpaypacatalogsrvService extends Service {
    ...
    static {
		...
		try {
			...
			LogManager.getLogger ( EpaypacatalogsrvService.class.getName () ).info (
							"Can not initialize the default wsdl from http://localhost:8080/epaypacatalogsrvApplEpaypacatalogsrvWs/EpaypacatalogsrvService?wsdl" );
		}
        WSDL_LOCATION = url;
    }
