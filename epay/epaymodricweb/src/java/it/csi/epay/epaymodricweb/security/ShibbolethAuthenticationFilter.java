    ...
    protected Object getPreAuthenticatedPrincipal(HttpServletRequest request) {
        ...
        try {
            if ( "enabled".equalsIgnoreCase ( shibbTestMode ) ) {
                token = "AAAAAA00A11C000K/10771180014/ADMIN_1000/DEMO 22/CSI PIEMONTE/INFOCERT_3/20180601094558/16/6fHlNBkfJYKdDRZP24vl4w==";
                ...
                String [] splitted = token.split ( "/" );
                principal.setIdentity ( token );
                principal.setCodiceEnte ( StringUtils.isNotBlank ( codiceEnte ) ? codiceEnte : "10771180014" );
                principal.setCodiceUtente ( splitted [0] );
            }
        } catch ( Exception e ) {
