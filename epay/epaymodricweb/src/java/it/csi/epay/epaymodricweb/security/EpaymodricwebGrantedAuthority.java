...
public class EpaymodricwebGrantedAuthority implements GrantedAuthority {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EpaymodricwebGrantedAuthority other = (EpaymodricwebGrantedAuthority) obj;
		if (codice == null) {
	...
	public EpaymodricwebGrantedAuthority(String codice, String descrizione, String descEstesa, String descMoltoEstesa, int tipoAuthority) {
		super();
		this.codice = codice;
	...
	public EpaymodricwebGrantedAuthority(String codice, String descrizione, int tipoAuthority) {
		super();
		this.codice = codice;
		this.descrizione = descrizione;
		this.tipoAuthority = tipoAuthority;
