...
public class HomeController extends AuthenticatedParentController {
    ...
    public String customLogout ( HttpServletRequest request, HttpServletResponse response ) {
         ...
         * e ); e.printStackTrace (); } try { logoutExternal ( host, EPAYMODRICWEB, request ); } catch ( MalformedURLException e ) { logger.error (
         * "EXCEPTION IN LOGOUT " + EPAYMODRICWEB + " : " + e ); e.printStackTrace (); } catch ( IOException e ) { logger.error ( "EXCEPTION IN LOGOUT " +
         * EPAYMODRICWEB + " : " + e ); e.printStackTrace (); }
         */
