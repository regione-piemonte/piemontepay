 ...
 */
public class ShibbolethAuthenticationFilter extends
    ...
    protected Object getPreAuthenticatedPrincipal(HttpServletRequest request) {
        ...
        try {
            if ( "enabled".equalsIgnoreCase ( shibbTestMode ) ) {
                token = "AAAAAA00A11D000L/80087670016/ADMIN_10/DEMO 23/CSI PIEMONTE/INFOCERT_3/20180601094558/16/6fHlNBkfJYKdDRZP24vl4w==";
                ...
                String [] splitted = token.split ( "/" );
                principal.setIdentity ( token );
                principal.setCodiceEnte ( StringUtils.isNotBlank ( codiceEnte ) ? codiceEnte : "80087670016" );
                principal.setCodiceUtente ( splitted [0] );
            }
        } catch ( Exception e ) {
