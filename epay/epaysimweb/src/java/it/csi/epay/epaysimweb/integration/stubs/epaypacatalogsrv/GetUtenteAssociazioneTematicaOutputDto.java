...
/**
 * <p>Classe Java per getUtenteAssociazioneTematicaOutputDto complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="getUtenteAssociazioneTematicaOutputDto"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="codice" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="codiciVersamento" type="{http://interfacews.epaypacatalogsrv.epay.csi.it/}getUtenteAssociazioneCodiceVersamentoOutputDto" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "getUtenteAssociazioneTematicaOutputDto", propOrder = {
    "codice",
    "codiciVersamento",
    "descrizione",
...
public class GetUtenteAssociazioneTematicaOutputDto {

    protected String codice;
    @XmlElement(nillable = true)
    protected List<GetUtenteAssociazioneCodiceVersamentoOutputDto> codiciVersamento;
     ...
     * {@link GetUtenteAssociazioneCodiceVersamentoOutputDto }
     * 
     * 
     */
    public List<GetUtenteAssociazioneCodiceVersamentoOutputDto> getCodiciVersamento() {
        if (codiciVersamento == null) {
            codiciVersamento = new ArrayList<GetUtenteAssociazioneCodiceVersamentoOutputDto>();
        }
