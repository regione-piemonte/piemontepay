...
import it.csi.epay.epaysimweb.frontend.AuthenticatedParentController;

@Aspect
public class RoleAspect {

    protected static final Logger LOGGER = LoggerFactory.getLogger ( LogConfig.HANDLER_ASPECT );

    private final static String REDIRECT_TO = "/ruoli/seleziona";

    @Around(value="execution(* it.csi.epay.simulatorweb.frontend..*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)", argNames = "joinPoint")
