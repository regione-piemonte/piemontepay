...
public class BusinessAspect {
    ...
    @Around(value="execution(* it.csi.epay.simulatorweb.business.manager.impl..*.*(..))", argNames = "joinPoint")
    ...
    @Around(value="execution(* it.csi.epay.simulatorweb.business.facade..*.*(..))", argNames = "joinPoint")
