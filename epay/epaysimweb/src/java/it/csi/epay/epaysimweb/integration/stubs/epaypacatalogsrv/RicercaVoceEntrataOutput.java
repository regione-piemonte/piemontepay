...
/**
 * <p>Classe Java per ricercaVoceEntrataOutput complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="ricercaVoceEntrataOutput"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="risultati" type="{http://interfacews.epaypacatalogsrv.epay.csi.it/}ricercaVoceEntrataOutputDto" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ricercaVoceEntrataOutput", propOrder = {
    "numeroRisultatiTotali",
    "risultati"
})
public class RicercaVoceEntrataOutput
    extends ParentOutput
{

    protected Integer numeroRisultatiTotali;
    @XmlElement(nillable = true)
    protected List<RicercaVoceEntrataOutputDto> risultati;
     ...
     * {@link RicercaVoceEntrataOutputDto }
     * 
     * 
     */
    public List<RicercaVoceEntrataOutputDto> getRisultati() {
        if (risultati == null) {
            risultati = new ArrayList<RicercaVoceEntrataOutputDto>();
        }
