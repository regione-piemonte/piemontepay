...
/**
 * <p>Classe Java per ricercaUtenteOutput complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="ricercaUtenteOutput"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="risultati" type="{http://interfacews.epaypacatalogsrv.epay.csi.it/}ricercaUtenteOutputDto" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ricercaUtenteOutput", propOrder = {
    "numeroRisultatiTotali",
    "risultati"
})
public class RicercaUtenteOutput
    extends ParentOutput
{

    protected Integer numeroRisultatiTotali;
    @XmlElement(nillable = true)
    protected List<RicercaUtenteOutputDto> risultati;
     ...
     * {@link RicercaUtenteOutputDto }
     * 
     * 
     */
    public List<RicercaUtenteOutputDto> getRisultati() {
        if (risultati == null) {
            risultati = new ArrayList<RicercaUtenteOutputDto>();
        }
