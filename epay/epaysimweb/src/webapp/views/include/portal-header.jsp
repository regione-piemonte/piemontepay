    ...
    <div class="container-fluid-banner container-portal-header">
        <div id="portalHeader">
            <noscript class="alert_js">
                <p>
                <spring:message code="include.portalheader.browsernonsupportaapplicazionijavascript"/><br />
                <spring:message code="include.portalheader.necessariojavascipt"/>
                </p>
            </noscript>
				         ...
				         <div class="row-fluid">
				            <div class="col-sm-4">
				                <p>
				                    ...
				                    <img alt="Regione Piemonte" src="/epaysimweb/ris/css/im/test_fesr.jpg" title="Regione Piemonte"></a>
				                </p>
				            </div>
				      </div>
				   </div>
        ...
        <div class="navbarLogin">     
            <div class="container-fluid pull-right">
                    <span class="login-text"><spring:message code="include.portalheader.utente"/>
						 <sec:authentication property="principal.utente.nome" /> <sec:authentication property="principal.utente.cognome" />
					</span>
                    <span class="login-text">
                    	<spring:message code="include.portalheader.ente"/> <sec:authentication property="principal.ente.denominazione" />
                    </span> 
