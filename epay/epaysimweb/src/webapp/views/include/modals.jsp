...
<div class="modal fade" id="modal-info" tabindex="-1" role="dialog" aria-labelledby="modal-info-label">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" data-dismiss="modal" id="modal-info-button-ok"><spring:message code="include.modals.ok"/></button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="commonModal_confirmDeletion">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<spring:message code="include.modals.sicurodivolereffettuareoperazionerichiesta"/>
			</div>
			<div class="modal-footer">
