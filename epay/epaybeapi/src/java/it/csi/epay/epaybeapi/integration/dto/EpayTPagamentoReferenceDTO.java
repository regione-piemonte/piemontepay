...
/**
 * Reference DTO for entity "epay_t_pagamento" <br>
 ...
 *
 */
public class EpayTPagamentoReferenceDTO implements Serializable {
    ...
    @NotNull
    private Boolean flagPagamentoAutenticato ;  // Boolean
     ...
     * Default constructor
     */
    public EpayTPagamentoReferenceDTO() {
        super();
    }
