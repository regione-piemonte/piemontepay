...
import it.csi.epay.epaybeapi.dto.common.ConfigurazioneDTO;
...
import it.csi.epay.epaybeapi.util.Environments;
import it.csi.epay.epaybeapi.util.ParametriApplicativo;
import it.csi.epay.epaybeapi.util.ParametriApplicativo.ExposurePolicy;
...
public class ConfigurazioneServiceImpl implements ConfigurazioneService, InitializingBean {
    ...
    private static final String DB_GROUP = "epaybeapi";
    ...
    public Map<String, Object> getBuildProperties () {
        ...
        if ( !isTest ) {
            ...
            output.put ( "componente", "epaybeapi" );
