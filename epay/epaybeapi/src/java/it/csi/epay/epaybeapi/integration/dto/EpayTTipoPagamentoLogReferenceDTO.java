...
/**
 * Reference DTO for entity "epay_t_tipo_pagamento_log" <br>
 ...
 *
 */
public class EpayTTipoPagamentoLogReferenceDTO implements Serializable {

    private static final long serialVersionUID = 1L;

    @NotNull
    private Long seq ; // Long // Id or Primary Key
    ...
    private Date dataTrigger ;  // Date 

    /**
     * Default constructor
     */
    public EpayTTipoPagamentoLogReferenceDTO() {
        super();
    }
