...
/**
 * DTO for entity "epay_t_errori" <br>
 ...
 *
 */
public class EpayTErroriDTO implements Serializable {
	...
	private EpayDStatoErroreReferenceDTO epayDStatoErrore ;


    /**
     * Default constructor
     */
    public EpayTErroriDTO() {
        super();
    }
    ...
    //----------------------------------------------------------------------
    public void setEpayDStatoErrore( EpayDStatoErroreReferenceDTO epayDStatoErrore ) {
        this.epayDStatoErrore = epayDStatoErrore;
    }
    public EpayDStatoErroreReferenceDTO getEpayDStatoErrore() {
