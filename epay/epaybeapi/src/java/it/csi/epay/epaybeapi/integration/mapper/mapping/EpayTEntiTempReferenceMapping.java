...
import it.csi.epay.epaybeapi.integration.dto.EpayTEntiTempReferenceDTO;
...
public interface EpayTEntiTempReferenceMapping {
    ...
    EpayTEntiTempReferenceDTO toDTO ( EpayTEntiTemp input );
