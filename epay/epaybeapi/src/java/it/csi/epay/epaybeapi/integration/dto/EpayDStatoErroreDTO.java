...
/**
 * DTO for entity "epay_d_stato_errore" <br>
 ...
 *
 */
public class EpayDStatoErroreDTO implements Serializable {

    private static final long serialVersionUID = 1L;

    @NotNull
    private Integer idStato ; // Id or Primary Key

    @Size( max = 200 )
    private String descrizione ; 

    private List<EpayTErroriReferenceDTO> listOfEpayTErrori ;


    /**
     * Default constructor
     */
    public EpayDStatoErroreDTO() {
        super();
    }
    ...
    //----------------------------------------------------------------------
    public void setListOfEpayTErrori( List<EpayTErroriReferenceDTO> listOfEpayTErrori ) {
        this.listOfEpayTErrori = listOfEpayTErrori;
    }
    public List<EpayTErroriReferenceDTO> getListOfEpayTErrori() {
