...
/**
 * Reference DTO for entity "epay_t_tipo_pagamento_temp" <br>
 ...
 *
 */
public class EpayTTipoPagamentoTempReferenceDTO implements Serializable {

    private static final long serialVersionUID = 1L;

    @NotNull
    private Long idTipoPagamentoTemp ; // Long // Id or Primary Key
    ...
    @NotNull
    @Size( min = 1, max = 100 )
    private String tipoOperazione ;  // String 

    /**
     * Default constructor
     */
    public EpayTTipoPagamentoTempReferenceDTO() {
        super();
    }
    ...
    /**
     *  Get the "flagMultibeneficiario" field value This field is mapped on the database column "multibeneficiario" ( type "bool" )
	...
	/**
	 *  Set the "flagMultibeneficiario" field value This field is mapped on the database column "multibeneficiario" ( type "bool" )
