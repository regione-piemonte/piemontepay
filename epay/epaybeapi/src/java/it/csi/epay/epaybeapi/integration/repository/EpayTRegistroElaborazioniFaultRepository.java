...
/**
 * Spring data Jpa repository for "EpayTRegistroElaborazioniFault" <br>
 *
 * @author EII
 */
@SuppressWarnings ( "unused" )
@Repository
public interface EpayTRegistroElaborazioniFaultRepository extends IRepository<EpayTRegistroElaborazioniFault, Long> {
}
