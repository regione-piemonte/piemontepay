...
/**
 * DTO for entity "epay_r_chiamante_autorizzazione_chiamante" <br>
 ...
 *
 */
public class EpayRChiamanteAutorizzazioneChiamanteDTO implements Serializable {
    ...
    @NotNull
    @Size( min = 1, max = 100 )
    private String codiceAutorizzazioneChiamante ; // Id or Primary Key
     ...
     * Default constructor
     */
    public EpayRChiamanteAutorizzazioneChiamanteDTO() {
        super();
    }
