...
/**
 * DTO for entity "epay_t_pagamento_riferimenti" <br>
 ...
 *
 */
public class EpayTPagamentoRiferimentiDTO implements Serializable {

    private static final long serialVersionUID = 1L;

    @NotNull
    private Long idRiferimento ; // Id or Primary Key
     ...
     * Default constructor
     */
    public EpayTPagamentoRiferimentiDTO() {
        super();
    }
