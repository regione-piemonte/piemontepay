...
/**
 * Spring data Jpa repository for "EpayTRegistroElaborazioni" <br>
 *
 * @author EII
 */
@SuppressWarnings ( "unused" )
@Repository
public interface EpayTRegistroElaborazioniRepository extends IRepository<EpayTRegistroElaborazioni, Long> {
}
