...
/**
 * Reference DTO for entity "epay_t_parametri" <br>
 ...
 *
 */
public class EpayTParametriReferenceDTO implements Serializable {

    private static final long serialVersionUID = 1L;

    @NotNull
    @Size( min = 1, max = 100 )
    private String gruppo ; // String // Id or Primary Key
    @NotNull
    @Size( min = 1, max = 100 )
     ...
     * Default constructor
     */
    public EpayTParametriReferenceDTO() {
        super();
    }
