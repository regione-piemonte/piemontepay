...
/**
 * Spring data Jpa repository for "EpayTPagamentoStorico" <br>
 *
 * @author EII
 */
@SuppressWarnings ( "unused" )
@Repository
public interface EpayTPagamentoStoricoRepository extends IRepository<EpayTPagamentoStorico, Long> {
}
