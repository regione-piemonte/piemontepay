...
import it.csi.epay.epaybeapi.dto.security.ScopeDTO;
...
public class ProfilazioneClientServiceImpl implements ProfilazioneClientService {
    ...
    private static ClientInfo clientAnonimo = ClientInfo.builder ()
        .withNome ( "GUEST" )
    ...
    private static ClientInfo clientSistema = ClientInfo.builder ()
        .withNome ( "SYSTEM" )
        .withCodice ( "SYSTEM" )
