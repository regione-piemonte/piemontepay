...
import it.csi.epay.epaybeapi.api.interceptors.RequestLoggingInterceptor;
...
import it.csi.epay.epaybeapi.business.impl.MessageServiceImpl;
import it.csi.epay.epaybeapi.dto.common.ErrorMessageDTO;
import it.csi.epay.epaybeapi.dto.common.MessaggioDTO;
import it.csi.epay.epaybeapi.dto.exception.ConflictException;
...
public class ErrorHandlerApiImpl implements ExceptionMapper<Exception> {
    ...
    private Response buildResponse ( ErrorMessageDTO errorMessage ) {
        ...
        String stacktrace = errorMessage.getErrore () != null && ConfigurazioneServiceImpl.isTestOrLower ()
