...
import it.csi.epay.epaybeapi.integration.repository.EpayDEsitoChiamataEsternaRepository;
...
/**
 * Spring data Jpa repository test for "EpayDEsitoChiamataEsterna" <br>
 *
 * @author EII
 */
...
@Transactional
public class EpayDEsitoChiamataEsternaRepositoryTest extends ParentHttpCallTest {
