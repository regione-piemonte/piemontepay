...
import it.csi.epay.epaybeapi.integration.repository.EpayTDatiSingoliVersamentiRepository;
...
/**
 * Spring data Jpa repository test for "EpayTDatiSingoliVersamenti" <br>
 *
 * @author EII
 */
...
@Transactional
public class EpayTDatiSingoliVersamentiRepositoryTest extends ParentHttpCallTest {
