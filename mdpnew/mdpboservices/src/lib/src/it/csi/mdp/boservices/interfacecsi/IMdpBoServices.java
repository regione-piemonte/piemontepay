...
public interface IMdpBoServices extends WrapperControl {
	...
	public List<EntiDTO> getEntiByParam(Credentials auth, String EnteId, String partitaIva, String descrizione, String attivo) throws RemoteException, DaoException, MissingParameterException,NamingException, AuthException;
	...
	public boolean isAlive() throws RemoteException, NamingException, CreateException;
