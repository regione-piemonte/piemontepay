...
public class InoltroFlussiRendicontazioneEstesiBCK {
	static LogUtil log = new LogUtil(InoltroFlussiRendicontazioneEstesiBCK.class);
		...
		for (FlussoRiversamento singoloFlusso : elencoFlussi) {
				...
				try {
					...
					numeroIuvOttici = gestioneSingoliPagamenti(elencoIuvNonTrovati, numeroIuvOttici,
							distictCodiciVersamento, flusso, elencoPagamentiIntermediati, testata);
