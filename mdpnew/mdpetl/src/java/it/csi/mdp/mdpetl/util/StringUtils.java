...
//	}
	...
	public static byte[] getKeyDB() {
		...
		} catch (Exception e)
		{
			...
			log.error(methodName, "errore chiave db" , e);
			e.printStackTrace();
...
//		}
	...
	public static String encodeStringValue(String toEncode, byte []sKey) throws SQLException {
		String fieldValueCifrato = null;
		if (sKey != null &&  toEncode!=null)
		{
