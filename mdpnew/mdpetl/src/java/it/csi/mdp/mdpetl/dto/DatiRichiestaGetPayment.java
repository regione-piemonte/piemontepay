...
public class DatiRichiestaGetPayment extends BaseDTO {
	 ...
	 *            the identificativoDominio to set
	 */
	 ...
	 *            the identificativoIntermediarioPa to set
	 */
	 ...
	 *            the identificativoStazioneIntermediarioPa to set
	 */
