...
package it.csi.mdp.mdpapi.testbed.helper;
...
public class TestHelperSendRT {
    ...
    public static final String SKEY_DB = "yYoThaIwl7gff2no8krJ6g==";
    ...
    public static PaSendRTReq creaConParametri () {
        ...
        List<CtTransferPA> transferListPA = transferList.getTransfer ();
        ...
        List<CtMapEntry> listMapEntry = metadata.getMapEntry ();
        CtMapEntry mapEntry = new CtMapEntry ();
        mapEntry.setKey ( "transaction_id" );
        mapEntry.setValue ( "TST000000000004021" );
