...
public class ElementoMultiversamento implements Serializable {
    ...
    @Column(name="xml_elemento")
    private String xmlElemento;

    @Generated ( "SparkTools" )
    private ElementoMultiversamento ( Builder builder ) {
        this.id = builder.id;
        ...
        this.xmlElemento = builder.xmlElemento;
    }
    ...
    public ElementoMultiversamento() {
    }
    ...
    public static final class Builder {
        ...
        public Builder withXmlElemento ( String xmlElemento ) {
            this.xmlElemento = xmlElemento;
            return this;
        }

        public ElementoMultiversamento build () {
            return new ElementoMultiversamento ( this );
        }
    }
