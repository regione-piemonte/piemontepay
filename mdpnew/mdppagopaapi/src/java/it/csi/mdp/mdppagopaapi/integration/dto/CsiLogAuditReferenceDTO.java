...
/**
 * Reference DTO for entity "csi_log_audit" <br>
 ...
 *
 */
public class CsiLogAuditReferenceDTO implements Serializable {

    private static final long serialVersionUID = 1L;

    @NotNull
    private Long idLog ; // Long // Id or Primary Key

    @NotNull
    private Date dataOra ;  // Date 
    @NotNull
    @Size( min = 1, max = 100 )
    private String idApp ;  // String 
    @Size( max = 40 )
    private String ipAddress ;  // String 
    @NotNull
    @Size( min = 1, max = 100 )
    private String utente ;  // String 
    @NotNull
    @Size( min = 1, max = 50 )
    private String operazione ;  // String 
    @NotNull
    @Size( min = 1, max = 500 )
    private String oggOper ;  // String 
    @NotNull
    @Size( min = 1, max = 500 )
    private String keyOper ;  // String 

    /**
     * Default constructor
     */
    public CsiLogAuditReferenceDTO() {
        super();
    }
