...
public class MdpCoreCxf implements IMdpCoreCxf
{
                    ...
                    throws  DaoException, NamingException, CreateException, MissingParameterException, CSIException
    {
        ...
        String ret = cPayment.startTransazione(t, tea, false);
    ...
    @Override
    @WebMethod
    public String startTransazioneCarrello(@WebParam(name = "t") Transazione t, @WebParam(name = "tea") TransazioneExtraAttribute[] tea, @WebParam(name="elencoRPT") ElencoRPT elencoRPT, @WebParam(name="multiBeneficiario") Boolean multiBeneficiario)
                    throws  BusinessException, SystemException
    {
        ...
        String ret = null;
        try {
            ret = cPayment.startTransazione ( t, tea, elencoRPT.getElenco (), multiBeneficiario != null ? multiBeneficiario : false );
