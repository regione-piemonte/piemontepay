...
//	public String startTransazione (@WebParam(name = "t")Transazione t, @WebParam(name = "tea")TransazioneExtraAttribute [] tea ) throws  DaoException, NamingException, CreateException, MissingParameterException, CSIException;
	...
	public String startTransazioneCarrello (@WebParam(name = "t")Transazione t, @WebParam(name = "tea")TransazioneExtraAttribute [] tea, @WebParam(name="elencoRPT") ElencoRPT elencoRPTE, @WebParam(name="multiBeneficiario") Boolean multiBeneficiario) throws  BusinessException, SystemException;
