...
public class GetTransazioneViewWithFiltersPagedResponse  implements java.io.Serializable {
    private it.csi.mdp.mdpboweb.business.ws.VtransazioneResult transactionResult;

    public GetTransazioneViewWithFiltersPagedResponse() {
    }
    ...
    /**
     * Gets the transactionResult value for this GetTransazioneViewWithFiltersPagedResponse.
     * 
    ...
    /**
     * Sets the transactionResult value for this GetTransazioneViewWithFiltersPagedResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetTransazioneViewWithFiltersPagedResponse)) return false;
        GetTransazioneViewWithFiltersPagedResponse other = (GetTransazioneViewWithFiltersPagedResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetTransazioneViewWithFiltersPagedResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://interfacecxf.boservices.mdp.csi.it/", "getTransazioneViewWithFiltersPagedResponse"));
