...
public class FindEntiAll  implements java.io.Serializable {
    ...
    /**
     * Gets the auth value for this FindEntiAll.
     * 
     * @return auth
     */
    ...
    /**
     * Sets the auth value for this FindEntiAll.
     * 
     * @param auth
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FindEntiAll)) return false;
        FindEntiAll other = (FindEntiAll) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FindEntiAll.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://interfacecxf.boservices.mdp.csi.it/", "findEntiAll"));
