...
public class CPBECpEliminaParametroConfigurazioneBO {
	...
	public final static String CPNAME = "cpEliminaParametroConfigurazioneBO";
	...
	public ExecResults indietro(
		...
		try {
			...
			/*PROTECTED REGION ID(R-1868561301) ENABLED START*/
	...
	public ExecResults salva(
		...
		try {
			ExecResults result = new ExecResults();
			/*PROTECTED REGION ID(R477723406) ENABLED START*/
			// inserire qui la logica applicativa da eseguire:
			...
			try {
				getGestoreMDPBackOffice().eliminaParametroConfigurazioneBO(
						user, inpPC);
			} catch (Exception e) {
				String faultString = e.getMessage();
				String message = pu.getMessage("TR-E-0101") + " Exception"
						+ pu.getMessage("TR-E-0102") + " deleteBoConfig()"
	...
	//////////////////////////////////////////////////////////////////////////////
	/*PROTECTED REGION ID(R1813007354) ENABLED START*/
