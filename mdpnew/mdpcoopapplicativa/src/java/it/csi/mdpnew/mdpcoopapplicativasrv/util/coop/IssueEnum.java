...
public enum IssueEnum {
	...
	DB_NO_DATA_FOUND_3ARGS("184", "Nessun {0} mappato/a sulla base dati di mdpcoopapplicativa per {1}: {2}"),
	DB_MORE_THAN_ONE_RESULT_3ARGS("185", "Trovati pi\u00F9 di un {0} sulla base dati di mdpcoopapplicativa per {1}: {2}"),
	DB_MORE_THAN_ONE_RESULT_AT_TIME_4ARGS("185", "Trovati pi\u00F9 di un {0} sulla base dati di mdpcoopapplicativa per {1}: {2} all'istante: {3}"),
	DB_MORE_THAN_ONE_RESULT_AT_TIME_5ARGS("185", "Trovati pi\u00F9 di un {0} sulla base dati di mdpcoopapplicativa per {1}: {2}, {3}: {4}"),

	// esito negativo per cause impreviste (problemi di tipo sistemistico)
	GENERIC_SYSTEM_ERROR("200"),
	//
	DB_ERROR_INSERT_RICHIESTA_1ARG("201", "Mancato inserimento della richiesta nella base dati mdpcoopapplicativa {0}"),
	DB_ERROR_UPDATE_RICHIESTA_1ARG("203", "Mancato update della richiesta nella base dati mdpcoopapplicativa {0}"),
	DB_ERROR_SAVE_ESITO_INVIO_1ARG("208", "Mancato salvataggio dell'esito invio nella base dati mdpcoopapplicativa {0}")
	;
	//@formatter:on
