...
public class Gatewaycustomfields implements Serializable
{
	/**
	 * 
	 */
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof Gatewaycustomfields)) {
			return false;
		}
		
		final Gatewaycustomfields _cast = (Gatewaycustomfields) _other;
